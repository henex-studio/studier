...
// The complete policy wording. The version of record is
// docs/privacy-policy.md; this page is what people actually read, and the
// two must say the same thing. If you change the meaning of any wording
// here, change it there and move the version string in both.
//
      ...
      <main className="container narrow">
        <section className="card">
          ...
          <p>
            ...
            reach us at <a href="mailto:privacy@henex.uk">privacy@henex.uk</a>.
          </p>
          <p>
          ...
          <p>
            Studier cannot yet delete an account by itself. If you want your account and
            everything in it removed, email{" "}
            <a href="mailto:privacy@henex.uk">privacy@henex.uk</a> from the address on the
            account and we will do it by hand. We will respond within 20 working days.
          </p>
          <p>
          ...
          <p>
            For anything the app cannot do for you, such as correcting your account email or
            deleting your account entirely, email{" "}
            <a href="mailto:privacy@henex.uk">privacy@henex.uk</a> from the address on your
            account.
          </p>
          <p>
          ...
          <p>
            You can withdraw your agreement to this policy at any time by asking us to delete
            your account.
          </p>
          ...
          <h2>Contact</h2>
          <p>
            <a href="mailto:privacy@henex.uk">privacy@henex.uk</a>
          </p>
